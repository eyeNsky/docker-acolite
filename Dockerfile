...
RUN mkdir /software
RUN cd /software && wget http://odnature.naturalsciences.be/downloads/remsem/acolite/acolite_py_linux_20181210.0.tar.gz
RUN cd /software && tar -xf acolite_py_linux_20181210.0.tar.gz
